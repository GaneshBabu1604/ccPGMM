...
new_means = matrix(new_means,101,length(length(which(cluster_labels==1))))
errors = t(mvrnorm(length(length(which(cluster_labels==1))),rep(0,101),diag(A$uniquenesses)))
scores = mvrnorm(length(length(which(cluster_labels==1))),rep(0,Q),diag(rep(1,Q)))
...
new_means = matrix(new_means,101,length(length(which(cluster_labels==2))))
errors = t(mvrnorm(length(length(which(cluster_labels==2))),rep(0,101),diag(A$uniquenesses)))
scores = mvrnorm(length(length(which(cluster_labels==2))),rep(0,Q),diag(rep(1,Q)))
M = A$loadings%*% t(scores)
...
new_means = matrix(new_means,101,length(length(which(cluster_labels==3))))
errors = t(mvrnorm(length(length(which(cluster_labels==3))),rep(0,101),diag(A$uniquenesses)))
scores = mvrnorm(length(length(which(cluster_labels==3))),rep(0,Q),diag(rep(1,Q)))
M = A$loadings%*% t(scores)
...
new_means = matrix(new_means,101,length(length(which(cluster_labels==4))))
errors = t(mvrnorm(length(length(which(cluster_labels==4))),rep(0,101),diag(A$uniquenesses)))
scores = mvrnorm(length(length(which(cluster_labels==4))),rep(0,Q),diag(rep(1,Q)))
M = A$loadings%*% t(scores)
