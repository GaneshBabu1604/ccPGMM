...
#Generating dataset with well separated clusters
sim_data = 1
...
#Generating the well separated data from four well separated Factor Analyzers(One for each cereal type and background)
for(g in 1:G){
